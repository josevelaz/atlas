 ...
 *
 * These definitions are the source of truth for the four tables that
 * Better Auth manages: `user`, `session`, `account`, and `verification`.
 *
 * Table names and column names MUST NOT be changed here without a
 * corresponding migration — Better Auth hard-codes these names in its
 * adapter layer.
 */
