// Atlas — sample mail data
//
// Typed SolidJS-friendly port of `docs/prototype/data.jsx` and the Tasks/Dates
// fixtures from `docs/prototype/screens.jsx`. Content, ordering, ids,
// timestamps, category labels, tags, and AI extraction text are preserved
...
const inbox: MailItem[] = [
	...
	},
	{
		...
		subject: "[atlas/core] 3 new mentions in pull requests",
		preview:
	...
	},
	{
		id: "i7",
		from: "Anya Volkov",
		addr: "anya@silvercreekdesign.com",
...
const feed: MailItem[] = [
	...
	},
	{
		id: "f6",
		from: "The Browser",
		addr: "newsletter@thebrowser.com",
...
const threadBody: Record<string, ThreadBody> = {
	i1: {
		from: "Priya Ramanathan",
		addr: "priya@atlas.co",
		time: "Today, 10:42 AM",
...
const tasks: TaskEntry[] = [
	{
		label: "Confirm pod A staffing — was the seventh req rolled into pod C?",
		due: "Before 1:1",
	...
	{
		label: "Review Marcus's SAFE redlines, esp. pro-rata clause",
		due: "Wed",
		source: "Marcus Okafor · Term sheet",
		id: "i2",
	},
	{
		label: "Review PR #482 (auth refactor) — third revision",
		due: "This week",
		source: "Jordan Vega · GitHub",
		id: "i5",
	},
	{
		label: "Reply to Anya re: illustration commission slot",
		due: "By Friday",
...
const dates: DateEntry[] = [
	...
	{
		label: "Intro call with Maya Chen — NorthStar",
		due: "Fri May 23, 2:30 PM",
		source: "Maya Chen · Calendly",
		id: "i8",
	},
	{
		label: "Walkthrough call with Marcus — SAFE redlines",
		due: "Tomorrow",
		source: "Marcus Okafor · Catalyst",
		id: "i2",
	},
	{
		label: "Amazon delivery — cable management sleeve",
		due: "Fri May 23",
		source: "Amazon shipping notice",
		id: "p3",
	},
	{
		label: "Flight DL 482 SFO→PDX",
		due: "Wed Nov 26, 6:14 PM",
		source: "Delta confirmation",
		id: "p2",
	},
];

/** The full Atlas sample dataset, preserved verbatim from the prototype. */
